...
# Tugas
## 1. Membuat RecyclerView di Android
Contoh item layout yang akan dipakai adalah satu gambar di sebelah kiri dan dua baris TextView di sebelah kanan seperti gambar berikut :

![alt-text](http://nextinspiration.us/img/recyclerview/Bildschirmfoto-2016-09-17-um-23.57.08-300x77.png)
...
```
Jika sudah kita akan langsung running aplikasinya dan akan muncul tampilan RecyclerView seperti di bawah ini.

![alt-text](http://nextinspiration.us/img/recyclerview/recyclerview_android_example.jpg)

## 2. Desain list item yang lebih bagus dan rapi menggunakan CardView, maka hasilnya akan menjadi seperti di bawah ini :
![alt-text](http://nextinspiration.us/img/recyclerview/recyclerview_cardview_android_example-576x1024.jpg)
